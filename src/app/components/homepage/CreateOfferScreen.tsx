...
export function CreateOfferScreen({ 
  ...
  const [isOnOffer, setIsOnOffer] = useState(true); // Pre-selected for offers
        ...
        <form onSubmit={(e) => { e.preventDefault(); handleSave(); }}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
            ...
            <div className="mb-4 bg-white rounded-xl p-3 shadow-sm border border-gray-200">
              <h3 className="font-bold text-gray-800 text-sm mb-3">Fotos de la oferta</h3>
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-2 mb-3">
                {selectedImages.map((img, index) => (
                  ...
                  >
                    <img src={img} alt={`Oferta ${index + 1}`} className="w-full h-full object-cover" />
                    <button
                      type="button"
              ...
              <p className="text-xs text-gray-500 text-center italic">
                Agrega más fotos para ilustrar tu oferta mejor
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200">
                ...
                <textarea
                  ...
                  rows={4}
                  placeholder="Describe tu oferta de manera detallada..."
                />
              </div>
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-3xl shadow-2xl text-center max-w-sm mx-4">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">¡Oferta publicada!</h3>
            <p className="text-gray-600 mb-6">Tu oferta ha sido publicada exitosamente.</p>
          </div>
        </div>
      )}
    </div>
