...
export function SidebarMenu({
  ...
  const handleLogoutClick = async () => {
    await logoutUser(); // Llamamos a la función externa
  ...
  const MenuItem = ({
    ...
    return (
      ...
      >
        <span
          className={`text-sm ${isActive ? "text-white font-semibold" : "text-gray-700 group-hover:text-orange-600"}`}
        >
          {label}
        </span>
        <ChevronRight
          className={`w-3.5 h-3.5 ${isActive ? "text-white" : "text-gray-400 group-hover:text-orange-600"}`}
        />
      </button>
    );
  };
  ...
  return (
    <>
      ...
      >
        ...
        {/* Menu Content */}
        <div
          className={`${isPermanent ? "pt-4" : "pt-2"} ${isCollapsed ? "p-2" : "p-6"} space-y-6`}
        >
          ...
          {isCollapsed && isPermanent ? (
            ...
            <>
              ...
              <button
                onClick={() =>
                  handleMenuItemClick(() => onNavigate("user-profile"))
                }
              ...
              >
                ...
                <div className="flex-1">
                  <h3
                    className={`font-bold text-sm ${currentScreen === "user-profile" ? "text-white" : "text-gray-900"}`}
                  >
                    María González
                  </h3>
                  <p
                    className={`text-xs ${currentScreen === "user-profile" ? "text-white/80" : "text-gray-600"}`}
                  >
                    @mariagonzalez
                  </p>
                </div>
                <ChevronRight
                  className={`w-4 h-4 ${currentScreen === "user-profile" ? "text-white" : "text-gray-400 group-hover:text-orange-600"}`}
                />
              </button>
              ...
              <div>
                <div className="flex items-center justify-between px-4 mb-3">
                  <button
                    onClick={() =>
                      handleMenuItemClick(() => onNavigate("home"))
                    }
                ...
                <div className="space-y-1">
                  <button
                    onClick={() =>
                      handleMenuItemClick(() => onNavigate("categories"))
                    }
                  ...
                  >
                    <svg
                      className={`w-4 h-4 ${currentScreen === "categories" ? "text-white" : "text-orange-600"}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span
                      className={`text-sm ${currentScreen === "categories" ? "text-white font-semibold" : "text-gray-700 group-hover:text-orange-600"}`}
                    >
                      Categorías
                    </span>
                  </button>
                  ...
                  <button
                    onClick={() =>
                      handleMenuItemClick(() => onNavigate("marketplace"))
                    }
                    className={`w-full text-left px-3 py-2 rounded-xl transition-colors flex items-center gap-2 group ${
                  ...
                  >
                    <svg
                      className={`w-4 h-4 ${currentScreen === "marketplace" ? "text-white" : "text-orange-600"}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span
                      className={`text-sm ${currentScreen === "marketplace" ? "text-white font-semibold" : "text-gray-700 group-hover:text-orange-600"}`}
                    >
                      Promociones
                    </span>
                  </button>
                  ...
                  <button
                    onClick={() =>
                      handleMenuItemClick(() => onNavigate("events"))
                    }
                    className={`w-full text-left px-3 py-2 rounded-xl transition-colors flex items-center gap-2 group ${
                  ...
                  >
                    <svg
                      className={`w-4 h-4 ${currentScreen === "events" ? "text-white" : "text-orange-600"}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span
                      className={`text-sm ${currentScreen === "events" ? "text-white font-semibold" : "text-gray-700 group-hover:text-orange-600"}`}
                    >
                      Eventos
                    </span>
                  </button>
                  ...
                  <button
                    onClick={() =>
                      handleMenuItemClick(() => onNavigate("lobby"))
                    }
                    className={`w-full text-left px-3 py-2 rounded-xl transition-colors flex items-center gap-2 group ${
                      currentScreen === "lobby"
                        ? "bg-gradient-to-r from-orange-500 to-red-600"
                  ...
                  >
                    <svg
                      className={`w-4 h-4 ${currentScreen === "lobby" ? "text-white" : "text-orange-600"}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span
                      className={`text-sm ${currentScreen === "lobby" ? "text-white font-semibold" : "text-gray-700 group-hover:text-orange-600"}`}
                    >
                      Bec Business
                    </span>
                  </button>
                  ...
                  <button
                    onClick={() =>
                      handleMenuItemClick(() =>
                        window.open("https://boliviaenunclic.com", "_blank"),
                      )
                    }
                  ...
                  <button
                    onClick={() =>
                      handleMenuItemClick(() =>
                        window.open("https://kumyy.com", "_blank"),
                      )
                    }
                    className="w-full text-left px-3 py-2 hover:bg-orange-50 rounded-xl transition-colors flex items-center gap-2 group"
                  >
                ...
                {isCuentaExpanded && (
                  <div className="space-y-1">
                    ...
                    <MenuItem
                      label="Mis favoritos"
                      onClick={() =>
                        handleMenuItemClick(() => onNavigate("favorites"))
                      }
                      screenId="favorites"
                    />
                    <MenuItem
                      ...
                      onClick={() =>
                        handleMenuItemClick(() => onNavigate("export-help"))
                      }
                    ...
                    <MenuItem
                      ...
                      onClick={() =>
                        handleMenuItemClick(() =>
                          window.open(
                            "https://wa.me/59178787878?text=Hola,%20busco%20un%20inversor%20para%20mi%20proyecto",
                            "_blank",
                          ),
                        )
                      }
                    ...
                    <MenuItem
                      ...
                      onClick={() =>
                        handleMenuItemClick(() =>
                          window.open(
                            "https://wa.me/59178787878?text=Hola,%20busco%20oportunidades%20de%20inversión",
                            "_blank",
                          ),
                        )
                      }
                ...
                {isInfoCuentaExpanded && (
                  <div className="space-y-1">
                    <MenuItem
                      label="GRATIS (anual)"
                      onClick={() =>
                        handleMenuItemClick(() => onNavigate("account-info"))
                      }
                    ...
                    <MenuItem
                      ...
                      onClick={() =>
                        handleMenuItemClick(() => onNavigate("change-account"))
                      }
                    ...
                    <MenuItem
                      ...
                      onClick={() =>
                        handleMenuItemClick(() => onNavigate("billing-history"))
                      }
              ...
              <div>
                <button
                  ...
                  className="w-full flex items-center justify-between px-4 mb-3 hover:bg-orange-50 rounded-lg transition-colors py-2"
                >
                  <h3 className="text-sm font-bold text-gray-700">Soporte</h3>
                  {isSoporteExpanded ? (
                    <Minus className="w-4 h-4 text-red-600" />
                  ) : (
                    <Plus className="w-4 h-4 text-red-600" />
                  ...
                  <div className="space-y-1">
                    <MenuItem
                      ...
                      onClick={() =>
                        handleMenuItemClick(() =>
                          window.open(
                            "https://wa.me/59178787878?text=Hola,%20necesito%20atención%20al%20cliente",
                            "_blank",
                          ),
                        )
                      }
                    ...
                    <MenuItem
                      ...
                      onClick={() =>
                        handleMenuItemClick(() =>
                          window.open(
                            "https://wa.me/59178787878?text=Hola,%20me%20gustaría%20destacar%20mi%20negocio%20o%20servicio",
                            "_blank",
                          ),
                        )
                      }
              ...
              <div>
                <button
                  ...
                  className="w-full flex items-center justify-between px-4 mb-3 hover:bg-orange-50 rounded-lg transition-colors py-2"
                >
                  <h3 className="text-sm font-bold text-gray-700">Acerca de</h3>
                  {isAcercaDeExpanded ? (
                    <Minus className="w-4 h-4 text-red-600" />
                  ) : (
                    <Plus className="w-4 h-4 text-red-600" />
                ...
                {isAcercaDeExpanded && (
                  <div className="space-y-1">
                    <MenuItem
                      ...
                      onClick={() =>
                        handleMenuItemClick(() => onNavigate("how-it-works"))
                      }
                    ...
                    <MenuItem
                      ...
                      onClick={() =>
                        handleMenuItemClick(() =>
                          window.open(
                            "https://www.youtube.com/@boliviaenunclic",
                            "_blank",
                          ),
                        )
                      }
              ...
              <div className="pt-4">
                <div className="px-4 py-4 mt-auto">
                  <Button
                    onClick={handleLogoutClick} // <-- Usamos nuestra nueva función
                    className="w-full bg-red-500 hover:bg-red-600 text-white py-6 rounded-2xl font-semibold flex items-center justify-center gap-2"
                  >
